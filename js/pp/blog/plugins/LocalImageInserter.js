dojo.provide("pp.blog.plugins.LocalImageInserter");
dojo.require("dojox.form.Uploader");

dojo.declare("pp.blog.plugins.LocalImageInserter",
    dijit._editor._Plugin,
    {
        ...
        createFileInput: function(){
            ...
            this.button = new dojox.form.Uploader({
                isDebug:true,
                //force:"html",
...
dojo.subscribe(dijit._scopeName + ".Editor.getPlugin",null,function(o){
    if(o.plugin){ return; }
    switch(o.args.name){
    case "LocalImageInserter":
        o.plugin = new pp.blog.plugins.LocalImageInserter({url: o.args.url});
    }
});
