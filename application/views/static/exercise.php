...
<?php $this->load->view("includes/head_start.php", array("title" => "Exercise")) ?>
        ...
        <div id="content">
            ...
            <div id="mainbar">
                ...
                <p>
                    ...
                    <ul>
                        <li>
                            <a href="http://www.ncbi.nlm.nih.gov/pmc/articles/PMC1724598/pdf/v037p00006.pdf" target="_blank">
                                ACOG guidelines for exercise during pregnancy
                            </a>
                        </li>
                        <li>
                            <a href="http://www.babycenter.com/pregnancy-exercises" target="_blank">
                                FAQ About Exercise and Pregnancy
                            </a>
                        </li>
                        <li>
                            <a href="/d/exerciseAndInfantSize">
                                How Maternal Exercise Affects Infant Size
                            </a>
                        </li>
                        <li>
                            <a href="/d/choosingActivities">
