...
<?php $this->load->view("includes/head_start.php", array("title" => "Midwifery Description")) ?>
...
<?php $this->load->view("includes/globalnav.php") ?>
        ...
        <div id="content">
            ...
            <div id="mainbar">
                ...
                <p>
                    The term midwife generally implies one of three things, 
                    either a woman has chosen to become a DEM, CPM, or CNM.  
                    Certified Professional Midwives and Direct Entry Midwives 
                    practice in the homebirth or sometimes the birth-center 
                    setting depending on the state in which they practice.  
                    In Ohio, CPM's and DEM's practice only in the homebirth 
                    setting while Certified Nurse Midwives practice in a hospital 
                    setting and maintain a collaborative relationship with doctors.
                </p>
