...
<?php $this->load->view("includes/head_start.php", array("title" => "Doula Myths vs Realities")) ?>
...
<?php $this->load->view("includes/globalnav.php") ?>
        ...
        <div id="content">
            ...
            <div id="mainbar">
                ...
                <p>
					1. Myth: A doula shows up for the labor and birth then leaves.<br/>
                ...
                <p>
					3. Myth: If you've met one doula, you've met them all.<br/>
                ...
                <p>
					4. Myth: A doula will interfere with medical advice.<br/>
                ...
                <p>
					5. Myth: A doula will "take over" the role of the partner.<br/>
                ...
                <p>
					6. Myth: A doula will take away "the best part of a nurse's job."<br/>
                ...
                <p>
					7. Myth: A doula has a negative opinion about a hospital setting.<br/>
                ...
                <p>
					...
					family member, friend, fill in the blank) is there.<br/>
                ...
                <p>
					9. Myth: A doula will leave if the mother gets an epidural.<br/>
                ...
                <p>
					10. Myth: Doulas secretly want to catch the baby.<br/>
                ...
                <p>
					11. Myth: Doulas only attend home births.<br/>
